...
class ProcessFrame84(gym.ObservationWrapper):    
    ...
    def process(frame):
        ...
        resized_screen = scipy.misc.imresize(img, (110,84))
        #print(resized_screen.shape)
        x_t = resized_screen[18:102, :]
        #print(x_t.shape)
        x_t = np.reshape(x_t, [84, 84, 1]).astype(np.float32)
        x_t /= 255.
        return x_t
...
class FrameStack(gym.Wrapper):   #ok
